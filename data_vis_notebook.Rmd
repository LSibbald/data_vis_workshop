...
Now the colors com from a default scale, but you can also use different build in scales: http://www.sthda.com/english/wiki/ggplot2-colors-how-to-change-colors-automatically-and-manually). Note: there are also colorblind-friendly color palettes available. See http://www.cookbook-r.com/Graphs/Colors_(ggplot2)/
