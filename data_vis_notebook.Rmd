...
Now the colors com from a default scale, but you can also use different build in scales: http://www.sthda.com/english/wiki/ggplot2-colors-how-to-change-colors-automatically-and-manually)
